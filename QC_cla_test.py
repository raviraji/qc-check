...
class DeviceInfo:
    ...
    def print(self):
        ...
        print(self.hostname())
        print(self.imx_module())
        print(self.imx_mac())
        print(self.get_lte_imei())
        print(self.get_sim_number())
        print(self.get_signal_quality())
        print(self.get_operator_name())
        print(self.get_lte_module_type())
        print(SDname)
        print(SDsize)
